...
function Customer() {
    ...
    const dummyData = [
      { id: 1, Name: "John Doe", BUYER_PHONE: "123-456-7890", Location: "City A", "Stock In Hand": 50 },
      { id: 2, Name: "Jane Smith", BUYER_PHONE: "987-654-3210", Location: "City B", "Stock In Hand": 30 },
    ];
                ...
                <ArgonBox pl={1}>
                  <Table
                    ...
                    rows={dummyData.map(row => ({
                      ...row,
                      Invoice: <Button variant="contained" onClick={openInvoiceCard}>Invoice</Button>,
                      Receipt: <Button variant="contained" onClick={openReceiptCard}>Receipt</Button>,
                    }))}
                  />
                </ArgonBox>
              </Card>
