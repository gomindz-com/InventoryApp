...
from .views import AdminUser, RegisterUser, LoginUser, UserRetrieveView, UserUpdateView, UserUpdatePasswordView, UserResetPasswordView, SubscribersListCreateView, SubscriberRetreiveUpdateDeleteView, UserActivityListView
