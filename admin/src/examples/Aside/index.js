          ...
          <ul className="navbar-nav">
            <li className="nav-item">
              <Link
                to="/dashboard"
                className={`nav-link  ${
                  location.pathname.includes("dashboard") ? "active bg-gradient-primary" : ""
                }`}
              >
            ...
            <li className="nav-item">
              <Link
                className={`nav-link text-white ${
                  location.pathname.includes("customers") ? "active bg-gradient-primary" : ""
                }`}
                to="/customers"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {/* <li className="nav-item">
              <Link
                className={`nav-link text-white ${
                  location.pathname.includes("billing") ? "active bg-gradient-primary" : ""
                }`}
                to="/billing"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li className="nav-item">
              <Link
                className={`nav-link text-white ${
                  location.pathname.includes("notifications") ? "active bg-gradient-primary" : ""
                }`}
                to="/notifications"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li className="nav-item">
              <Link
                className={`nav-link text-white ${
                  location.pathname.includes("profile") ? "active bg-gradient-primary" : ""
                }`}
                to="/profile"
              >
                <div className="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li className="nav-item">
              ...
              >
                ...
                <span className="nav-link-text ms-1">Sign Out [Admin]</span>
              </button>
            </li>
          </ul>
        </div>
