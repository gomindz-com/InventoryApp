...
class mProduct(models.Model):
    ...
    owner = models.ForeignKey('users.MobileUser', related_name='%(class)s_mobile_products', on_delete=models.CASCADE,  default=1)
...
class Damages(models.Model):
    ...
    created_date = models.DateField(auto_now_add=True)
    owner = models.ForeignKey('users.MobileUser', related_name='damage', on_delete=models.CASCADE, default='')